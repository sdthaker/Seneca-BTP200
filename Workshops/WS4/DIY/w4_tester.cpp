...
int main() {
   ...
   Label theProgram("/-\\|/-\\|", "Professor's Label Maker Program Tester"),
   EmptyOne1,
   EmptyOne2("ABCDEFGH");

   //below will also work
   /*Label theP("/-\\|/-\\|", "Professor's Label Maker Program Testerssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss");*/
   cout << "EmptyOne1" << endl;
